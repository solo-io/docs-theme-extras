...
export default defineConfig({
  ...
  projects: [
    ...
    // visible.
    {
      name: "content",
      testMatch:
        /markdown-leaks\.spec\.ts$|missing-images\.spec\.ts$|built-html-integrity\.spec\.ts$|copy-md-fidelity\.spec\.ts$|hugo-warnings\.spec\.ts$|dev-build\.spec\.ts$|curl-quotes\.spec\.ts$|tab-syntax\.spec\.ts$|shortcode-args\.spec\.ts$|heading-shortcode-id\.spec\.ts$|include-form\.spec\.ts$|gate-form\.spec\.ts$|gate-axis-collision\.spec\.ts$|cascade-type\.spec\.ts$|scan-roots\.spec\.ts$|gate-normalize-corpus\.spec\.ts$|gate-inline-form\.spec\.ts$|reuse-image-pair-lint\.spec\.ts$/,
    },
    {
      name: "browser",
