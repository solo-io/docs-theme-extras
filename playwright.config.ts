  ...
  projects: [
    {
      name: "static",
      testMatch:
        /static\.spec\.ts$|versioning\.spec\.ts$|hugo-warnings\.spec\.ts$|auto-cards\.spec\.ts$|presence\.spec\.ts$|curl-quotes\.spec\.ts$|shortcode-args\.spec\.ts$|include-form\.spec\.ts$|github-shortcode\.spec\.ts$/,
    },
    {
      name: "browser",
