export const SHORTCODE_MARKERS = [
  ...
  "MARKER_ALERT_INDENTED",
  "MARKER_ALERT_INDENTED_HTML",
  "MARKER_CALLOUT_INFO",
  ...
  "MARKER_STEPS_TABS_A",
  "MARKER_STEPS_TABS_B",
  "MARKER_SCRIPTREUSE_PROSE",
  "MARKER_SCRIPTREUSE_SINGLELINE",
  "MARKER_SCRIPTREUSE_MULTILINE",
  "MARKER_SCRIPTREUSE_LISTENER",
  "MARKER_SCRIPTREUSE_TAIL",
  "MARKER_MULTIBLOCK_LEAD",
  "MARKER_MULTIBLOCK_FENCE_BEFORE",
  "MARKER_MULTIBLOCK_TAB_A",
  "MARKER_MULTIBLOCK_TAB_B",
  "MARKER_MULTIBLOCK_TRAIL",
  "MARKER_LISTBREAK_BEFORE",
  "MARKER_LISTBREAK_AFTER",
  "MARKER_SETEXT_PROSE_HEAD",
  "MARKER_SETEXT_PROSE_TAIL",
  "MARKER_SETEXT_CLUSTER_1",
  "MARKER_SETEXT_CLUSTER_2",
  "MARKER_SVG_ALT",
  "MARKER_PRISM",
  "MARKER_OPENAPI",
  "MARKER_READFILE",
